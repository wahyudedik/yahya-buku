                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('admin.branding.show')">
                                    {{ __('Branding') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('admin.hero.show')">
                                    {{ __('Hero Section') }}
                                </x-dropdown-link>
                                ...
                                <x-dropdown-link :href="route('admin.footer.index')">
                                    {{ __('Footer') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('admin.careers.index')">
                                    {{ __('Karir') }}
                                </x-dropdown-link>
