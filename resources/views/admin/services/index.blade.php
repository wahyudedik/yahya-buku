                                ...
                                @forelse($services as $service)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($service->icon)
                                                <img src="{{ asset('storage/' . $service->icon) }}" alt="{{ $service->name }}" class="h-10 w-10 rounded-full object-cover">
                                            @else
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @if($service->is_featured)
                                                <span class="text-xs text-blue-600 bg-blue-100 px-2 py-0.5 rounded-full">Unggulan</span>
                                            @endif
                                        </td>
