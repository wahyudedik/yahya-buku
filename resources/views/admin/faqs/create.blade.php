                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.faqs.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="answer" name="answer" rows="4" class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm" required>{{ old('answer') }}</textarea>
